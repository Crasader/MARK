...
void ManagerGrid::dealBattle()
{
	...
	/*ManagerHandle::getInstance()->notify((int)ID_OBSERVER::HANDLE_ENTITY, TYPE_OBSERVER_HANDLE_ENTITY::RUN_ENTITY_ACTION);*/
}
...
void ManagerGrid::dealEffective(DataGrid *dataGrid, const vector<string> &args)
{
	...
	/*ManagerHandle::getInstance()->notify((int)ID_OBSERVER::HANDLE_GRID, TYPE_OBSERVER_HANDLE_GRID::UPDATE_GRID, dataGrid->getId());*/
}
