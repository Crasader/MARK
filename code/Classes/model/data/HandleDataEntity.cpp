...
void HandleDataEntity::dealSkillRandom(const function<void()> &func /*= nullptr*/)
{
	...
	if (isSet)
	{
		/*ManagerHandle::getInstance()->notify((int)ID_OBSERVER::LAYER_GRID_SELECT, TYPE_OBSERVER_LAYER_GRID_SELECT::RUN_MAID_GRID_PLAY_SPECIAL_STH_GENERATE, CallFunc::create(func));*/
	}
	else
	{
...
void HandleDataEntity::addRound()
{
	...
	/*ManagerHandle::getInstance()->notify((int)ID_OBSERVER::LAYER_BATTLE, TYPE_OBSERVER_LAYER_BATTLE::UPDATE_TXT_ROUND);*/
}
